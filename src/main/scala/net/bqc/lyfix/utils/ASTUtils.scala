...
import net.bqc.lyfix.context.diff.SourceRange
import net.bqc.lyfix.context.parser.JavaParser
import net.bqc.lyfix.identifier.fault.PredefinedFaultIdentifier
import net.bqc.lyfix.identifier.node.VariableIdentifier
import net.bqc.lyfix.identifier.{Identifier, PositionBasedIdentifier, SimpleIdentifier}
